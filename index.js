...
bot.on('callback_query', query => {
    ...
    if (type === START) {
        ...
        let answer = ''
        let question = `<b>Вопрос</b>: Кому первоначально поставили памятник перед Третьяковской галереей? (укажите только фамилию в дательном падеже)`
...
bot.on('message', (msg) => {
    ...
    switch (msg.text.toLowerCase()) {
        ...
        case '8':
            ...
            lat = 55.743497
            lon = 37.625981
            photo = 'https://sobory.ru/pic/02150/02158_20140428_222338.jpg'
